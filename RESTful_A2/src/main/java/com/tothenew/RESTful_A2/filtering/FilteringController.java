...
//    Ques8. Create API which saves details of User (along with the password) but on successfully
//    saving returns only non-critical data. (Use static filtering)

//@RestController
//public class FilteringController {
//    @GetMapping("/filtering")
//    public UserDetails retriveUserDetails(){
//        return new UserDetails("Kandy","12345678");
//    }
//}
...
public class FilteringController {
    ...
    public MappingJacksonValue retriveUserDetails() {
        ...
        UserDetails userDetails = new UserDetails("Kandy", "12345678");
