...
public class FirstTest {
    ...
    void shouldReturnNewString_When_SubstringIsFound() {
        //given
        String mainString = "Kandy Arora is a Trainee";
        String findstring = "Trainee";
        String replacedString = "Employee";
        String expectedString = "Kandy Arora is a Employee";
    ...
    void shouldReturnOriginalString_When_SubstringIsNotFound() {
        //given
        String mainString = "Kandy Arora";
        String findstring = "Kandy";
        String replacedString = "Arjun";
        String expectedString = "Arjun Arora";
